...
const hours = setInterval( () => {
    ...
    if (eventDate < now) {
        ...
        document.getElementById('eventTimeStampMessage').innerHTML = `Venha para meu aniversário!!! Aguardo você em ${daysToEvent}d ${hoursToEvent}h ${minutesToEvent}m ${secondsToEvent}s`;
